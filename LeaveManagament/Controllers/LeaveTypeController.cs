...
namespace LeaveManagament.Controllers
{
    public class LeaveTypeController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,NumberOfDays,DateCreated,DateModified")] LeaveType leaveType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,NumberOfDays,DateCreated,DateModified")] LeaveType leaveType)
        {
            if (id != leaveType.Id)
            {
                return NotFound();
