...
namespace LeaveManagament.Data.Migrations
{
    ...
    [Migration("20260924224320_AddLeaveRequestsTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LeaveManagament.Data.LeaveRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LeaveManagament.Data.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateModified = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "Vacation",
                            NumberOfDays = 24
                        },
                        new
            ...
            modelBuilder.Entity("LeaveManagament.Data.LeaveRequest", b =>
                {
                    b.HasOne("LeaveManagament.Data.LeaveType", "LeaveType")
                        .WithMany()
                        .HasForeignKey("LeaveTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LeaveManagament.Data.ApplicationUser", "RequestingEmployee")
                        .WithMany()
                        .HasForeignKey("RequestingEmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LeaveManagament.Data.ApplicationUser", "Reviewer")
                        .WithMany()
